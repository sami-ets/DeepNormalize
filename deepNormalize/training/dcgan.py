...
from deepNormalize.utils.utils import to_html, to_html_per_dataset, to_html_JS, to_html_time, count, \
    ...
    get_all_patches, rebuild_images, save_rebuilt_images, rebuild_augmented_images, save_augmented_rebuilt_images, \
...
class DCGANTrainer(Trainer):
    ...
    def train_step(self, inputs, target):
        ...
        if self._should_activate_autoencoder():
            ...
            disc_loss, disc_pred, disc_target, x_conv1, x_layer1, x_layer2, x_layer3 = self._train_d(
                ...
                target[NON_AUGMENTED_TARGETS][DATASET_ID], self._discriminator_loss_train_gauge)
    ...
    def validate_step(self, inputs, target):
        if self._should_activate_autoencoder():
            ...
            _, _ = self._valid_s(self._model_trainers[SEGMENTER], inputs[NON_AUGMENTED_INPUTS],
                                 target[IMAGE_TARGET])
