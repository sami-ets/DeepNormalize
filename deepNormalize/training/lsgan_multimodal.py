...
class LSGANMultimodalTrainer(Trainer):
    ...
    def __init__(self, training_config, model_trainers: List[ModelTrainer],
        ...
        super(LSGANMultimodalTrainer, self).__init__("LSGANMultimodalTrainer", train_data_loader, valid_data_loader,
    ...
    def _train_d(self, D: ModelTrainer, real, fake, target, loss_gauge: AverageGauge):
        ...
        target_ohe = to_onehot(target.long(), num_classes=self._num_datasets)
