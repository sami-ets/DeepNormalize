...
class UNetMultimodalTrainer(Trainer):
    ...
    def __init__(self, training_config, model_trainers: List[ModelTrainer],
        ...
        super(UNetMultimodalTrainer, self).__init__("UNetMultimodalTrainer", train_data_loader, valid_data_loader, test_data_loader,
