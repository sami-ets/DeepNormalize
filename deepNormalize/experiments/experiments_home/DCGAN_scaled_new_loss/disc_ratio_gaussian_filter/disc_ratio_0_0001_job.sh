...
#SBATCH --output=DCGAN_home_new_loss_scaled_gaussian_filter_disc_ratio_0_0001.out
#SBATCH --job-name=DCGAN_home_new_loss_scaled_gaussian_filter_disc_ratio_0_0001
nvidia-smi
