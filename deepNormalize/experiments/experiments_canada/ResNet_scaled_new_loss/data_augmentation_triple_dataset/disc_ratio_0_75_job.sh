...
#SBATCH --output=ResNet_canada_new_loss_scaled_disc_ratio_data_augmentation_0_75.out
#SBATCH --job-name=ResNet_canada_new_loss_scaled_disc_ratio_data_augmentation_0_75
nvidia-smi
