...
#SBATCH --output=ResNet_home_new_loss_scaled_disc_ratio_data_augmentation_dual_dataset_1_50.out
#SBATCH --job-name=ResNet_home_new_loss_scaled_disc_ratio_data_augmentation_dual_dataset_1_50
nvidia-smi
