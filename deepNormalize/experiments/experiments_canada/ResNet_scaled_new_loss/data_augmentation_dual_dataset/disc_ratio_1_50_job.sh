...
#SBATCH --output=ResNet_canada_new_loss_scaled_disc_ratio_data_augmentation_dual_dataset_1_50.out
#SBATCH --job-name=ResNet_canada_new_loss_scaled_disc_ratio_data_augmentation_dual_dataset_1_50
nvidia-smi
source /home/pld2602/venv/bin/activate
CUDA_VISIBLE_DEVICES=0 python /project/def-lombaert/pld2602/code/deepNormalizev5/main_cc.py --config=/home/pld2602/projects/def-lombaert/pld2602/code/deepNormalizev5/deepNormalize/experiments/experiments_canada/ResNet_scaled_new_loss/data_augmentation_dual_dataset/config_data_augmentation_dual_dataset_disc_ratio_1.50.yaml